...
def_dist_list <-  
  list(
    unguarded = c(7, 99),
    guarded = c(3, 7),
    tightly_guarded = c(0, 3)
)

# mapply(function(x, y) x + y, list(x1 = c(1,2), x2 = c(1,3)), list(y1 = c(0,0), y2 = c(1,1)))
# 
# params_test <- expand.grid(a = list(x1 = c(1,2), x2 = c(1,3)), b = list(y1 = c(0,0), y2 = c(1,1)))
# mapply(function(x, y) x + y ,params_test$a, params_test$b)
