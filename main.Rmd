...
```{r}
df_test$knn_probs <- predict.train(fitted_models[["knn"]], df_test, type = "prob")[,2]
calibration_curve <- calibration(fgm ~ knn_probs, data = df_test)
calibration_curve
xyplot(calibration_curve, auto.key = list(columns = 1))
```
