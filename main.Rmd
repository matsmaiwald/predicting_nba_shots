...
in_training <- createDataPartition(y = df$shot_result, p = 0.5, list = FALSE)
...
```{r}
confusionMatrix(model_predictions$ridge,df_test$shot_result, positive = "made")
...
# roc_curve <- roc(response = df_train$shot_result, predictor = df_train$probs)
# auc(roc_curve)
# plot(roc_curve, legacy.axes = TRUE)
```
